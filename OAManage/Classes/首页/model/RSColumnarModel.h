...
/**报表管理*/
/**入库*/
@property (nonatomic,strong)NSString * volumeIn;
/**出库*/
@property (nonatomic,strong)NSString * volumeOut;
/**收款*/
@property (nonatomic,strong)NSString * bmStorageFee;
/**空地租金*/
@property (nonatomic,strong)NSString * bmSpaceRent;

/**入库差异比*/
@property (nonatomic,strong)NSString * areaIn;
/**出库差异比*/
@property (nonatomic,strong)NSString * areaOut;


/**大板收款差异比*/
@property (nonatomic,strong)NSString * slAmount;
/**条板收款差异比*/
@property (nonatomic,strong)NSString * smAmount;
/**业务楼收款差异比*/
@property (nonatomic,strong)NSString * pmAmount;
