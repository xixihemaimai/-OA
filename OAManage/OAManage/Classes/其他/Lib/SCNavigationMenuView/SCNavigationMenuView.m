...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.backgroundColor = [UIColor colorWithRed:106/255.0 green:122/255.0 blue:145/255.0 alpha:1];
...
#define NavigationTitleDefaultFont [UIFont systemFontOfSize:17]
#define NavigationTitleDefaultColor [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1]
...
- (UIImageView *)arrowImageView
{
    if (!_arrowImageView) {
        ...
        _arrowImageView.image = [UIImage imageNamed:@"system-pull-down"];
